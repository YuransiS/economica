              ...
              {alreadyPaidInfo ? (
                ...
                <div className="text-center pt-2">
                  <p className="text-xs text-gray-500 leading-tight">
                    Надсилаючи заявку, ви погоджуєтесь з <a href="/privacy-policy" target="_blank" className="text-[#4E0000] underline hover:text-[#81D8D0]">політикою конфіденційності</a>
                  </p>
                </div>
