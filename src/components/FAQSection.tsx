...
export default function FAQSection({ onOpenLeadAction }: { onOpenLeadAction: () => void }) {
  const faqs = [
    ...
    {
      question: "Чи потрібен мені міні курс, якщо я вже маю інвестиційний портфель?",
    ...
    },
    {
      ...
      answer: "На курсі ми даємо максимум чітких покрокових стратегій, для того щоб у вас не залишилось питань, і ви могли самостійно повністю повторити весь шлях"
    },
    {
      question: "Я поки не планую інвестувати",
      answer: "Пройшовши міні курс ви точно зможете оцінити всі ризики, які є зараз в світі та прийняти для себе рішення чи починати вам все ж інвестувати зараз чи ні."
    }
  ];
