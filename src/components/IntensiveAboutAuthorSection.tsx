...
export default function IntensiveAboutAuthorSection({ onOpenLeadAction }: { onOpenLeadAction: () => void }) {
  return (
    <section className="bg-[#1A0000] py-24 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl relative z-10">
        <div className="mb-24 flex justify-center">
          ...
          >
            <blockquote className="font-script text-3xl md:text-5xl leading-relaxed text-[#FBCBDA] mb-8 relative">
        ...
        >
          <h3 className="font-montserrat text-2xl md:text-4xl font-bold text-[#FBCBDA] mb-6 leading-relaxed uppercase">
            Ви теж можете вийти на щомісячний пасивний дохід, <br/><span className="text-white">якщо матимете чітку систему</span>
          </h3>
          <p className="font-arimo text-xl text-gray-400 mb-12 leading-relaxed">
            На інтенсиві будемо розбирати, як аналізувати та формувати власний інвестиційний портфель, який буде примножувати в доході, а не створювати головний біль. Навіть під час світової кризи, яка насувається.
          </p>
