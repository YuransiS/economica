...
export default function IntensiveWhatAwaitsSection({ onOpenLeadAction }: { onOpenLeadAction: () => void }) {
  const items = [
    "3 ефіри",
  ...
  return (
    <section className="bg-[#4E0000] py-24 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl text-center relative z-10">
        ...
        >
          Що на вас чекає <br/><span className="text-[#FBCBDA]">на інтенсиві:</span>
        </motion.h2>
