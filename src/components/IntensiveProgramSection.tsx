  ...
  const days = [
    {
      ...
      points: [
        ...
        "Отримаєте практичне домашнє завдання, щоб закріпити отримані знання на практиці."
      ],
      color: "bg-[#81D8D0]"
    },
    {
    ...
    },
    {
      ...
      points: [
        "Детально розберу свою стратегію інвестування, та покажу свій портфель, який працює на мене останні 6 років",
