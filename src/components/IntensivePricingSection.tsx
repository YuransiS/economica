...
export default function IntensivePricingSection({ onOpenLeadAction }: { onOpenLeadAction: (tariff: string, price: number) => void }) {
  const tariff = {
    name: "Безкоштовно",
    oldPrice: 9,
    price: 0,
    features: [
      ...
      "Додаткові матеріали і таблиці для легшого засвоєння інформації",
    ],
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl relative z-10">
        ...
        <div className="max-w-xl mx-auto text-left">
          ...
          >
            ...
            <h3 className="font-montserrat text-4xl font-black mb-8 text-center text-[#FBCBDA]">Інтенсив</h3>
            ...
            <div className="text-center mb-6">
              ...
              <span className="font-montserrat text-4xl md:text-5xl font-black text-[#81D8D0] block mt-2">
                БЕЗКОШТОВНО
              </span>
            </div>
