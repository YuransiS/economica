...
export default function IntensiveFAQSection({ onOpenLeadAction }: { onOpenLeadAction: () => void }) {
  const faqs = [
    {
    ...
    {
      question: "Боюсь, що так і не зрозумію під час ефіру, як створювати інвестиційний портфель",
      answer: "Саме тому у всіх учасників буде домашнє завдання, щоб всі точно засвоїли на практиці всю отриману інформацію та могли користуватись нею в звичайному житті"
    },
    {
      question: "Я поки не планую інвестувати",
      answer: "Пройшовши інтенсив ви отримаєте інформацію про інвестування, яку зможете використовувати все життя. Тому що це база без якої не варто навіть починати. А коли саме ви використаєте ці знання вже вирішувати вам."
    }
  ];
